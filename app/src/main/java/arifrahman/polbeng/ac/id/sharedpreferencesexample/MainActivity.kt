package arifrahman.polbeng.ac.id.sharedpreferencesexample
...
import arifrahman.polbeng.ac.id.sharedpreferencesexample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        const val RPL = "TESTFILE" // Mendefinisikan konstanta RPL
    }
